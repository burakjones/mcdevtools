    ...
    <div class="{navShown ? 'block' : 'hidden'} lg:block lg:sticky lg:left-0 lg:top-0 lg:h-screen lg:min-w-[22rem] lg:max-w-[22rem] lg:min-h-screen z-40">
        <div class="flex flex-col h-full pl-6 border-r-white/10 border-r">
            <div class="flex w-full items-center flex-col space-y-6 my-6 pr-6">
                ...
                <input class="search" bind:value={searchValue} on:input={handleInput} type="text" placeholder="Bir araç ara" on:keypress={handleKeyPress} on:blur={handleInput}>
            </div>
    ...
    <div class="flex flex-col w-full justify-between">
        ...
        <div class="my-8">
            <div class="flex w-fit mx-auto justify-center items-center relative z-20 text-center">
                <p class="text-white/50 px-10">Hala Discord sunucumuza katılmadın mı? <a href="https://discord.gg/mcdevcommunity" aria-label='Flyte' target="_blank" class="underline underline-offset-2 hover:text-white/80 transition-colors">Discord</a> — Bu Website <a class="underline underline-offset-2 hover:text-white/80 transition-colors" target="_blank" aria-label='GitHub' href="https://github.com/flytegg/mc-utils/issues">tarafından geliştirilip Apcu tarafından revize edilmiştir.</a>.</p>
            </div>
            <div class="mt-5 flex xl:hidden w-fit mx-auto justify-center items-center relative z-20 text-center text-white">
                <p class="text-white/50 px-10">Discord Sunucumuza Katıl <a class="underline underline-offset-2 hover:text-white/80 transition-colors hover:text-[#5562ea]" target="_blank" aria-label='GitHub' href="https://discord.gg/mcdevcommunity">Discord</a></p>
            </div>
        </div>
    </div>
</div>
...
<div class="fixed xl:block hidden inset-x-0 bottom-8 bg-opacity-90 px-4 py-3 z-10">
    <div class="flex justify-center items-center">
        <a href="https://discord.gg/mcdevcommunity" target="_blank" class="absolute right-6 bg-[#767ADE]/20 hover:bg-[#767ADE] group border-[#767ADE] transition-colors border rounded-xl px-4 py-3">
