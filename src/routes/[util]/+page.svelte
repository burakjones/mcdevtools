...
<svelte:head>
    <title>{data.util.name ? data.util.name : "Not Found"} | MC Dev Tools</title>
    <meta content="MC Dev Tools" property="og:site_name" />
    <meta content="{data.util.name ? data.util.name : 'Not Found'} | MC Dev Tools" property="og:title" />
...
{:else}
    <div class="flex flex-col items-center m-16 gap-y-16">
        <div class="flex flex-col items-center gap-y-12">
            ...
            <h1 class="text-white/60 text-xl">Ne olduğunu pek anlayamadık... <a href="https://discord.gg/mcdevscommunity" target="_blank" class="underline hover:text-white/100 transition-colors">istersen Discord sunucumuza katıl!</a></h1>
        </div>
