<svelte:head>
    ...
    <meta content="MC Dev Tools" property="og:title" />
    <meta content="MC Dev Tools" property="og:site_name" />
    <meta content="Sunucu yöneticileri, geliştiriciler ve oyuncular için Minecraft araçları içerir. Sunucu dosyalarını indir, eşya kimliklerini görüntüle, skin ve pelerinleri kopyala, envanter slot kimliklerine bak, bayraklar ve havai fişekler oluştur, renk kodlarını al ve daha fazlası." property="og:description" />
    <meta content="https://mcdevtools.tr" property="og:url" />
    <meta content="https://mcdevtools.tr/favicon.png" property="og:image" />
    <meta content="#2b2d31" data-react-helmet="true" name="theme-color" />
    <meta name="description" content="Sunucu yöneticileri, geliştiriciler ve oyuncular için Minecraft araçları içerir. Sunucu dosyalarını indir, eşya kimliklerini görüntüle, skin ve pelerinleri kopyala, envanter slot kimliklerine bak, bayraklar ve havai fişekler oluştur, renk kodlarını al ve daha fazlası.">
...
<div class="flex flex-col items-center mt-16 mx-14">
    <div class="flex flex-col items-center gap-y-10">
        ...
        <h1 class="text-white/60 text-xl text-center">Geliştiriciler, mimarlar ve oyuncular için topluluk destekli Minecraft araçları.</h1>
    </div>
