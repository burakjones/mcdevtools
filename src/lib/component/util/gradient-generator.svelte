<script lang="ts">
    ...
    function copyValue() {
        ...
        toast.push('Başarıyla kopyalandı!', {
            theme: {
...
<main class="w-[60%]">
    <div class="place-items-center text-center items-start grid grid-cols-1 xl:flex justify-center gap-6">
        <div class="flex flex-col">
            <h3 class="font-medium text-white text-20px text-left">Mesaj</h3>
        ...
        <div class="flex gap-6">
            <div class="flex flex-col">
                <h3 class="font-medium text-white text-20px text-left">Renk #1</h3>
            ...
            <div class="flex flex-col h-full">
                <h3 class="font-medium text-white text-20px text-left">Renk #2</h3>
    ...
    <div class="flex flex-col">
        <h3 class="font-medium text-white text-[20px] mt-8 text-center">Sohbet Renkleri</h3>
        <div class="flex gap-3">
            ...
            <button class="w-fit text-sm px-2 py-1.5 button h-fit inline-block mt-5" on:click={copyValue}>Kopyala</button>
        </div>
    </div>

    <div class="flex flex-col">
        <h3 class="font-medium text-white text-[20px] mt-8 text-center">Mini Mesajlar</h3>
        <div class="flex gap-3">
            ...
            <button class="w-fit text-sm px-2 py-1.5 button h-fit inline-block mt-5" on:click={copyMinimessageValue}>Kopyala</button>
        </div>
    </div>

    <div class="flex flex-col">
        <h3 class="font-medium text-white text-[20px] mt-8 text-center">Önizleme</h3>
