    ...
    <div class="flex-col flex">
        <div class="place-items-center text-center items-start grid grid-cols-1 xl:flex justify-center gap-6">
            ...
            <div class="flex-col flex gap-1">
                ...
                <button class="button w-[100%] h-8 text-sm flex items-center justify-center" on:click={() => insertTextAtCursor("&" + color)}>Hex Renk Kodu Ekle</button>
            </div>
            <div class="flex gap-1">
                <div class="flex-col flex gap-1">
                    <button class="button w-[100%] h-8 text-sm text-center flex items-center justify-center font-bold" on:click={() => insertTextAtCursor("&l")}>Kalın</button>
                    <button class="button w-[100%] h-8 text-sm flex items-center justify-center underline" on:click={() => insertTextAtCursor("&n")}>Altı çizili</button>
                </div>
                <div class="flex-col flex gap-1">
                    <button class="button w-[100%] h-8 text-sm flex items-center justify-center italic" on:click={() => insertTextAtCursor("&o")}>İtalik</button>
                    <button class="button w-[100%] h-8 text-sm flex items-center justify-center line-through" on:click={() => insertTextAtCursor("&m")}>Üstü çizili</button>
                </div>
                <div class="flex-col flex gap-1">
                    <button class="button w-[100%] h-8 text-sm flex items-center justify-center" on:click={() => insertTextAtCursor("&k")}>Büyücü</button>
                    <button class="button w-[100%] h-8 text-sm flex items-center justify-center" on:click={() => insertTextAtCursor("&r")}>Sıfırla</button>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-3">
            ...
            <button class="w-fit text-sm px-2 py-1.5 button h-fit inline-block mt-8" on:click={copyValue}>Kopyala</button>
        </div>
    </div>

    <div class="flex flex-col">
        <h3 class="font-medium text-white text-[20px] mt-8 text-center mb-5">Önizleme</h3>
