...
<input class="search w-[26rem]" on:keypress={handleKeyPress} on:blur={handleInput} bind:value={searchValue} on:input={handleInput} type="text" placeholder="Eşya ismi girin...">

<table class="w-[90%] md:w-[80%] lg:w-[60%] mt-12 table-fixed">
    <tr class="text-[#9d9d9e] font-medium">
        <th class="p-2 pl-6 w-0 pr-2"></th>
        <td class="p-2 pr-4 border-b-[1.5px] border-b-[#232324]">İsim</td>
        ...
        <td class="text-left pr-3 w-[15%] border-b-[1.5px] border-b-[#232324]">Stack Büyüklüğü</td>
    </tr>
