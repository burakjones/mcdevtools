...
<main class="w-[90%] lg:w-[60%] mt-5 flex-col flex justify-center">
    ...
    {:else if selectedType === "Modpack size"}
        <p class="text-gray-400 text-lg mb-1 text-left">{['Küçük', 'Orta', 'Büyük'][mods]}</p>
    ...
    <button class="button w-fit text-sm" on:click={StartFile}>Başlatma Dosyası Oluştur</button>
