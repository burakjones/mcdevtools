...
<main class="w-[60%] flex flex-col">
    <div class="flex flex-wrap mx-auto gap-10 mt-[-5px]">
        <div class="flex flex-col self-center mx-auto">
            <h3 class="font-medium text-white text-[20px] text-left">Saat (24 Saat)</h3>
        ...
        <div class="flex gap-4 self-center pt-3 mx-auto">
            <div class="flex flex-col self-center mb-4">
                <h3 class="font-medium text-white text-[20px] text-left">Minecraft Süresi (Ticks)</h3>
            ...
            <button class="w-fit text-sm px-3 text-center py-1.5 button h-fit self-center" on:click={copyValue}>Kopyala</button>
        </div>
    </div>
    <h3 class="font-medium text-white text-[20px] mt-8 text-center mb-3 ">Tam Gün Işığı Döngüsü</h3>
